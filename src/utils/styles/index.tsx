...
const withClasses = <Component, ComponentProps extends {}>(
  Component: React.ComponentType<Component>,
  componentName: string,
  defaultSeedStyleMap: Map<string, string>,
  tw: TW,
) =>
  ...
  class WithClasses extends React.Component<
    ComponentProps & WithClassesProps<BaseClassesProps>,
    WithClassesProps<BaseClassesProps>
  > {
    state = {
    ...
    componentDidMount() {
      ...
      let seedStyleMap = addGlobalCss({
        seedStyleMap: defaultSeedStyleMap,
        componentName,
        tw,
      });
    ...
    render() {
      ...
      //@ts-expect-error
      return (
        <Component {...rest} classes={this.state.classes} />
      ) as React.Component<
        ComponentProps & WithClassesProps<BaseClassesProps>,
        any
      >;
