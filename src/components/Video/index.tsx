    ...
    (
      ...
      return (
        ...
        `}
          ref={ref}
        ></video>
          {showAudioLevel && audioLevelDisplayType==='border' && audioLevel && <AudioLevelIndicator type={'border'} level={audioLevel} displayShape={displayShape} classes={{videoCircle:classes.videoCircle}} color={audioLevelDisplayColor}/>}
        </>
      );
    },
  );