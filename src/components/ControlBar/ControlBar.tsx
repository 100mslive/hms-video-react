...
export const ControlBar = ({
  ...
  return (
    <div className="flex h-full p-1 relative items-center">
      ...
      <div 
        className="flex-none right-0 absolute m-2"
        >
        <button 
          className="inline-block right-0 p-2 m-2 w-40 rounded-lg bg-red-main">
         <div 
         ...
         <div 
         className="inline-block pl-1 text-lg text-white"
         >
           Leave Room
          </div>
        </button>
