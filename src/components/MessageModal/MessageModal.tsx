...
export const MessageModal= ({
  ...
  <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
    <div className="fixed inset-0 backdrop-opacity-100 transition-opacity" aria-hidden="true"></div>
      ...
      {/* <div className="bg-gray-100 px-4 pt-5 pb-4 sm:p-6 sm:pb-3"> */}
        {/* <div className="sm:flex sm:items-start sm:flex-wrap"> */}
          ...
          <div className="flex flex-col md:flex-row md:flex-wrap bg-gray-100 rounded-lg sm:items-start md:w-100 focus:outline-none rounded-tr-lg text-center font-normal pb-4 sm:text-left">
            ...
            <div className="flex flex-grow lg:text-2xl sm:text-xl md:h-9 sm:h-7 self-center items-center text-white font-medium">{title}</div>
            ...
            <button type="button" className="w-full justify-end shadow-sm text-base font-medium rounded-xl focus:outline-none">
              {Close}
            </button>
          </div>
          </div>
